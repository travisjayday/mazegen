...
#include "header/helpers.h"		// for printing maze and general stuff
#include "header/mazegen.h"		// for generating a maze
#include "header/mazesolve.h"	// for solving a maze
